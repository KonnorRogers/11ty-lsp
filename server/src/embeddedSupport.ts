// https://github.com/microsoft/vscode-extension-samples/blob/main/lsp-embedded-language-service/server/src/embeddedSupport.ts
/*---------------------------------------------------------------------------------------------
...
import { Position, LanguageService, TokenType, Range } from 'vscode-html-languageservice';
